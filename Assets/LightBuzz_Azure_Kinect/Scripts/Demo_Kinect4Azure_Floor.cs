    ...
    public class Demo_Kinect4Azure_Floor : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            if (frame != null)
            {
                ...
                //Checking whether the field of view for floor detection is okay or not
                Debug.Log(frame.FloorFrameSource.Floor.FieldOfView);

                //If okay, print coordinates
                if (frame.FloorFrameSource.Floor.FieldOfView == FieldOfView.OK)
                {
                    //Debug.Log(frame.FloorFrameSource.Floor.X + ":" + frame.FloorFrameSource.Floor.Y + ":" + frame.FloorFrameSource.Floor.Z + ":" + frame.FloorFrameSource.Floor.W);
                    Debug.Log("height is : "+frame.FloorFrameSource.Floor.Height + "Tilt is : "+frame.FloorFrameSource.Floor.Tilt);
                }
            }
        }
